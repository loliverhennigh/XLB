...
from operators.optimize.gradient_descent import GradientDescent
from operators.optimize.clamp_field import ClampField

class GradientDescentSubroutine(OOCGridSubroutine):

    def __init__(
        self,
        gradient_descent: Operator = GradientDescent(),
        clamp_field: Operator = None,
        nr_streams: int = 1,
