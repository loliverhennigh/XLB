...
from tiles.dynamic_tile import DynamicTile, DynamicGPUTile, DynamicCPUTile
...
class OOCArray:
    ...
    def __init__(
        ...
        if self.codec is None:
            ...
            self.Tile = DynamicTile
            self.ComputeTile = DynamicGPUTile
            self.StoreTile = DynamicCPUTile
